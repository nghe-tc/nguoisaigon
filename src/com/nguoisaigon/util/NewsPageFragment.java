...
public class NewsPageFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_news_page, container, false);

		TextView tvNgayDang = (TextView) rootView.findViewById(R.id.TextView1);
		TextView tvCreateDate = (TextView) rootView.findViewById(R.id.tvNewsCreateDate);
		...
		tvNgayDang.setTypeface(Utils.tf);
		tvCreateDate.setTypeface(Utils.tf);
		tvTitle.setTypeface(Utils.tf);
		tvContent.setTypeface(Utils.tf);
