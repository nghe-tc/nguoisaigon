...
public class Emailplugin {
	...
	static public Boolean SendEmail(Context context, String[] toRecipient, String subject, String body,
			Bitmap attatchment) {
		...
		try {
			if (attatchment != null) {
				...
				String path = Images.Media.insertImage(context.getContentResolver(), attatchment,
						"tempImageForSendMail", null);
